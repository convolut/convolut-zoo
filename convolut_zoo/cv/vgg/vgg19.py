...
class VGG19(VGG):
    def __init__(self,
        ...
        mapping = {
            ...
            'features.16': 'features.4.3.conv',

            'features.19': 'features.6.0.conv',
            'features.21': 'features.6.1.conv',
            'features.23': 'features.6.2.conv',
            'features.25': 'features.6.3.conv',

            'features.28': 'features.8.0.conv',
            'features.30': 'features.8.1.conv',
            'features.32': 'features.8.2.conv',
            'features.34': 'features.8.3.conv',
        }
