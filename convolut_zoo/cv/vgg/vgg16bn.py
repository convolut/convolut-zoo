...
class VGG16Bn(VGG):
    def __init__(self,
        ...
        mapping = {
            ...
            'features.24': 'features.6.0.conv',
            'features.25': 'features.6.0.batch_norm',
            'features.27': 'features.6.1.conv',
            'features.28': 'features.6.1.batch_norm',
            'features.30': 'features.6.2.conv',
            'features.31': 'features.6.2.batch_norm',

            'features.34': 'features.8.0.conv',
            'features.35': 'features.8.0.batch_norm',
            'features.37': 'features.8.1.conv',
            'features.38': 'features.8.1.batch_norm',
            'features.40': 'features.8.2.conv',
            'features.41': 'features.8.2.batch_norm',
        }
