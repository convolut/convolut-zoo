...
class VGG13Bn(VGG):
    def __init__(self,
        ...
        mapping = {
            ...
            'features.21': 'features.6.0.conv',
            'features.22': 'features.6.0.batch_norm',
            'features.24': 'features.6.1.conv',
            'features.25': 'features.6.1.batch_norm',

            'features.28': 'features.8.0.conv',
            'features.29': 'features.8.0.batch_norm',
            'features.31': 'features.8.1.conv',
            'features.32': 'features.8.1.batch_norm',
        }
